...
public class ProductValidator {
    ...
    public void nullCheckCategoryId(String category_id) throws ClientException{
        if(category_id == null){
    ...
    public void validateProductId(Integer id) throws ClientException{
        if(id <= 0){
            throw new ClientException("Product id input is required");
        }
    }
    ...
    public void validateCategoryId(String category_id) throws ClientException{
        if(category_id.length() != 6 || !category_id.startsWith("PC")){
            throw new ClientException("Product with id contains six digits and starts with 'PC'");
        }
    }
